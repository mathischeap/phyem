...
from phmpi.generic.py._2d_unstruct.form.main import MPI_Py_2D_Unstructured_Form
from phmpi.generic.py.vector.localize.static import MPI_PY_Localize_Static_Vector

from phmpi.generic.py.tools.nolinear_operation.AxB_ip_C import MPI_PY_AxBipC
...
from legacy.generic.py.linear_system.localize.dynamic.array_templates import _find_py_space_through_pure_lin_repr
...
# ====================================================================================================
from legacy.generic.py.linear_system.localize.dynamic.array_templates import _parse_root_form
from legacy.generic.py.linear_system.localize.dynamic.array_templates import Parse__M_matrix
from legacy.generic.py.linear_system.localize.dynamic.array_templates import Parse__E_matrix
...
class _MPI_PY_TrStarRf0DualPairingTrS1(Frozen):
    ...
    def __init__(self, dls, tr_star_rf0, rf1):
        ...
        from legacy.generic.py.linear_system.localize.dynamic.bc import Natural_BoundaryCondition
