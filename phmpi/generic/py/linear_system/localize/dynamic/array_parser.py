...
from phmpi.generic.py.linear_system.localize.dynamic.array_templates import *
...
def MPI_py_array_parser(dls, array_lin_repr):
    """"""
    ...
    if array_lin_repr[-_len_rf_ap_lin_repr:] == _root_form_ap_lin_repr:
        ...
        # natural bc vector =================================================
        elif type_indicator == _find_indicator(_VarSetting_boundary_dp_vector):
