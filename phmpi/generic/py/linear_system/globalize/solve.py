...
from phmpi.generic.py.linear_system.globalize.solvers._py_mpi import _PY_MPI_solvers
from phmpi.generic.py.linear_system.globalize.solvers._scipy import _PackageScipy
...
class MPI_PY_Solve(Frozen):
    ...
    def x0(self, args):
        ...
        if args == 0:  # make a full zero initial guess
            ...
            from phmpi.generic.py.gathering_matrix import MPI_PyGM
