...
from phmpi.generic.py.tools.nolinear_operation.base_3_entries import MPI_PY_Base3Entries

_MPI_PY_3d_data_cache_py_AxB_C = {}


class MPI_PY_AxBipC(MPI_PY_Base3Entries):
    """"""
    ...
    def _make_3d_data(self):
        ...
        if self._cache_key in _MPI_PY_3d_data_cache_py_AxB_C:
            self._3d_data = _MPI_PY_3d_data_cache_py_AxB_C[self._cache_key]
            return
        ...
        _MPI_PY_3d_data_cache_py_AxB_C[self._cache_key] = _3d_data
