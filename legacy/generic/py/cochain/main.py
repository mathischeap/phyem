...
from legacy.generic.py.vector.localize.static import Localize_Static_Vector_Cochain
from legacy.generic.py.vector.localize.dynamic import Localize_Dynamic_Vector_Cochain
