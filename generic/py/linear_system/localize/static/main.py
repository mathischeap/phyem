...
from generic.py.matrix.localize.bmat import bmat
from generic.py.vector.localize.concatenate import concatenate

from generic.py.linear_system.localize.static.customize import _Customize

from generic.py.linear_system.globalize.static import Globalize_Static_Linear_System
