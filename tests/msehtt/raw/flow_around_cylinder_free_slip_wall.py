# -*- coding: utf-8 -*-
r"""
mpiexec -n 4 python tests/msehtt/flow_around_cylinder_free_slip_wall.py
"""
...
results_dir = './__phcache__/msehtt_flow_around_cylinder_free_slip_wall/'

# msehtt.info()

msehtt_nls = obj['nls'].apply()
msehtt_nls.config(('essential bc', 1), boundary_u, bc_velocity)  # essential bc
msehtt_nls.config(['natural bc', 1], boundary_p, u.numeric.tsp.L2_energy())  # natural bc
msehtt_nls.config(('essential bc', 1), boundary_w, init_vorticity)  # essential bc
