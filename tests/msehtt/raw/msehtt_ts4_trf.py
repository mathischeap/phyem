# -*- coding: utf-8 -*-
r"""
mpiexec -n 4 python tests/msehtt/raw/msehtt_ts4_trf.py
"""
...
def rff(x, y):
    return np.sin(3.121541 * np.pi * x) * np.sin(3.2841 * np.pi * y)
...
# msehtt.config(tgm)('crazy', element_layout=5, trf=trf, ts=0)
msehtt.config(tgm)('chaotic', element_layout=3, c=0.3, bounds=bounds, trf=0, ts=2)
# msehtt.config(tgm)('test_mesh.phm')
# tgm.visualize(quality=False)
