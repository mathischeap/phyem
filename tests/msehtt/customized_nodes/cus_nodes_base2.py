# -*- coding: utf-8 -*-
"""
Test the basic functionalities like reduction, reconstruction, incidence matrices, errors for
customized nodes.

mpiexec -n 4 python tests/msehtt/customized_nodes/cus_nodes_base2.py
"""
...
tgm = msehtt.tgm()
msehtt.config(tgm)('crazy', element_layout=K, c=c)
_mesh = obj['mesh']
...
# print(fo0[None].error())
# print(fi0[None].error())
# print(fo1[None].error())
# print(fi1[None].error())
# print(fo2[None].error())
# print(fi2[None].error())
