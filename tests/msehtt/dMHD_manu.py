...
filename = f"p1_Rf{_rf_}Rm{_rm_}_1overC{int(1/_c_)}_N{N}K{K}_steps{steps_per_second}"
...
u_L2_error_s1, j_L2_error_s1, B_L2_error_s1, w_L2_error_s1, P_L2_error_s1 = test_results[0][3:8]

np.testing.assert_almost_equal(u_L2_error_s1, 0.2859393417461602, decimal=5)
np.testing.assert_almost_equal(j_L2_error_s1, 0.009278384450707972, decimal=7)
np.testing.assert_almost_equal(B_L2_error_s1, 0.0021100439987784708, decimal=7)
np.testing.assert_almost_equal(w_L2_error_s1, 0.36708005003222377, decimal=5)
np.testing.assert_almost_equal(P_L2_error_s1, 0.21461992188862597, decimal=5)
