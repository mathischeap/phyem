# -*- coding: utf-8 -*-
"""
Test the reduction and reconstruction for msehtt mesh built upon unstructured quadrilateral regions.

mpiexec -n 4 python tests/msehtt_vtu/base2_msehtt.py
"""
