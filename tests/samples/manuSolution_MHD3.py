...
class ManufacturedSolutionMHD3_0(Frozen):
    """This manufactured solution is used in the decoupled MHD paper. With B.C."""
...
# ================================================================
def _curlE_x(t, x, y, z):
    return _dEz_dy(t, x, y, z) - _dEy_dz(t, x, y, z)


def _curlE_y(t, x, y, z):
    return _dEx_dz(t, x, y, z) - _dEz_dx(t, x, y, z)


def _curlE_z(t, x, y, z):
    return _dEy_dx(t, x, y, z) - _dEx_dy(t, x, y, z)


def _Bx(t, x, y, z):
    """"""
    return - _curlE_x(t, x, y, z) + _curlE_x(0, x, y, z)


def _By(t, x, y, z):
    """"""
    return - _curlE_y(t, x, y, z) + _curlE_y(0, x, y, z)


def _Bz(t, x, y, z):
    """"""
    return - _curlE_z(t, x, y, z) + _curlE_z(0, x, y, z)


class ManufacturedSolutionMHD3_1(Frozen):
    """This manufactured solution is used  in periodic domain [0, 2pi]^3"""
    ...
    def E(self):
        """Electronic field."""
        return T3dVector(_Ex, _Ey, _Ez)

    @property
    def B(self):
        """Electronic field."""
        return T3dVector(_Bx, _By, _Bz)
