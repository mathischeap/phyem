...
class MseHtt_GreatMesh_Unique_MsePy_Hexahedron_Element(MseHttGreatMeshBaseElement):
    ...
    def nodes(self):
        ...
        mp = self._ct.mapping
        return {
            self._map[0]: mp(-1, -1, -1),
            self._map[1]: mp(1, -1, -1),
            self._map[2]: mp(-1, 1, -1),
            self._map[3]: mp(1, 1, -1),
            self._map[4]: mp(-1, -1, 1),
            self._map[5]: mp(1, -1, 1),
            self._map[6]: mp(-1, 1, 1),
            self._map[7]: mp(1, 1, 1),
        }
