...
from phyem.msehtt.static.space.mass_matrix.Lambda.MM_m3n3k2 import mass_matrix_Lambda__m3n3k2


def norm_Lambda__m3n3k2(tpm, degree, cochain, norm_type='L2', component_wise=False):
    """"""
    if component_wise:
        return ___norm_Lambda__m3n3k2_component_wise___(tpm, degree, cochain, norm_type=norm_type)
    else:
        pass
...
from phyem.msehtt.static.space.reconstruct.Lambda.Rc_m3n3k2 import reconstruct_Lambda__m3n3k2


def ___norm_Lambda__m3n3k2_component_wise___(tpm, degree, cochain, norm_type='L2'):
    r""""""
    ...
    U, V, W = reconstruct_Lambda__m3n3k2(tpm, degree, cochain, *nodes, ravel=False)[1]
    local_norm_U = []
    local_norm_V = []
    local_norm_W = []
    if norm_type == 'L2':
        ...
        raise NotImplementedError(f"___norm_Lambda__m3n3k2_component_wise___ not implemented for norm_type={norm_type}")
