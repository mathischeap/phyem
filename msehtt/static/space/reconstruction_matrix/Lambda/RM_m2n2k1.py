...
def rm__m2n2k1_outer(tpm, degree, xi, et):
    ...
    for e in elements:
        ...
        if etype in ("orthogonal rectangle", "unique msepy curvilinear quadrilateral"):
            ...
            RM_u[e], RM_v[e] = ___rm221o_quad_9___(element, degree, xi, et)
        else:
...
def ___rm221o_quad_9___(element, degree, xi, et):
    """"""
...
def rm__m2n2k1_inner(tpm, degree, xi, et):
    ...
    for e in elements:
        ...
        if etype in ("orthogonal rectangle", "unique msepy curvilinear quadrilateral"):
            ...
            RM_u[e], RM_v[e] = ___rm221i_quad_9___(element, degree, xi, et)
...
def ___rm221i_quad_9___(element, degree, xi, et):
    """"""
    reverse_info = element.dof_reverse_info
