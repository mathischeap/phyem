...
def basis_function_Lambda__m2n2k2(etype, degree, xi_1d, eta_1d):
    """"""
    if etype in ('unique msepy curvilinear quadrilateral', 'orthogonal rectangle'):
        local_numbering = ___bf222_msepy_quadrilateral___(degree, xi_1d, eta_1d)
    else:
...
def ___bf222_msepy_quadrilateral___(degree, xi_1d, eta_1d):
    """"""
    ...
    add_to_ndarray_cache(_cache_bf222_mq_, [xi_1d, eta_1d], data, check_str=key)
    return data
