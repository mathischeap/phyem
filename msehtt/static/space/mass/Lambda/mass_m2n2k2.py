...
def mass_Lambda__m2n2k2(tpm, degree, cochain):
    """"""
    ...
    for e in elements:
        ...
        if etype in (
            ...
            element_mass = _mass222_msepy_quadrilateral_(
...
def _mass222_msepy_quadrilateral_(element, local_cochain, degree):
    """"""
    p = element.degree_parser(degree)[0]
    p = (p[0] + 2, p[1] + 2)
    nodes, weights = quadrature(p, 'Gauss').quad
    _, _, u = ___rc222_msepy_quadrilateral___(element, degree, local_cochain, *nodes, ravel=False)
