...
from msehy.py2.space.reconstruction_matrix.main import MseHyPy2ReconstructMatrix
from msehy.py2.space.error.main import MseHyPy2SpaceError
from msehy.py2.space.norm.main import MseHyPy2SpaceNorm
from msehy.py2.space.incidence_matrix.main import MseHyPy2IncidenceMatrix
from msehy.py2.space.mass_matrix.main import MseHyPy2MassMatrix
...
class MseHyPy2Space(Frozen):
    ...
    def incidence_matrix(self):
        """incidence matrix"""
        if self._E is None:
            self._E = MseHyPy2IncidenceMatrix(self)
        return self._E
    ...
    def mass_matrix(self):
        """mass matrix"""
        if self._M is None:
            self._M = MseHyPy2MassMatrix(self)
        return self._M
    ...
    def reconstruction_matrix(self):
        ...
        if self._reconstruct_matrix is None:
            self._reconstruct_matrix = MseHyPy2ReconstructMatrix(self)
