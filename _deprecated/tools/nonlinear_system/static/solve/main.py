...
from msehy.tools.nonlinear_system.static.solve.Newton_Raphson import IrregularNonlinearSystemNewtonRaphsonSolve


class IrregularStaticNonlinearSystemSolve(Frozen):
    """"""
    def __init__(self, nls):
        ...
        self._Newton_Raphson = IrregularNonlinearSystemNewtonRaphsonSolve(nls)
        self._message = ''
        self._info = None
        self._freeze()
