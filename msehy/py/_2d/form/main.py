...
from generic.py._2d_unstruct.form.main import Frozen, GenericUnstructuredForm2D
from msehy.py._2d.space.main import MseHyPy2Space

from msehy.py._2d.form.numeric.main import MseHyPy2RootFormNumeric
...
class MseHyPy2RootForm(Frozen):
    ...
    def __init__(self, abstract_root_form):
        ...
        # -------- properties -----------------------------------------------------
        self._cf_cache = None
        self._numeric = MseHyPy2RootFormNumeric(self)
    ...
    def _initialize(self):
        ...
        if self._do_initialize:
            ...
            self._generic = GenericUnstructuredForm2D(
            ...
            if self.space.previous is None:
                ...
                self._previous = GenericUnstructuredForm2D(
